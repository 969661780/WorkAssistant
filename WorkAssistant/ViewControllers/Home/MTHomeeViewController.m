//
//  MTHomeeViewController.m
//  WorkAssistant
//
//  Created by mt y on 2018/7/12.
...
#import <Masonry.h>
@interface MTHomeeViewController ()<UITableViewDelegate,UITableViewDataSource>

@property (weak, nonatomic) IBOutlet UIScrollView *scroolMy;
...
@implementation MTHomeeViewController
...
- (void)viewDidLoad {
    ...
    if (@available(iOS 11.0, *)) {
        self.scroolMy.contentInsetAdjustmentBehavior = UIScrollViewContentInsetAdjustmentAlways;
    } else {
...
-(void)getData
{
    ...
    self.timeDetailyLable.text = [MTGetDate getCurrentDate];
